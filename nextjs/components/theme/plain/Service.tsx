        ...
        <div className="service-card__body">
          {
            Logo || Logo2 ? (
              <div className="service-card__logo-wrapper">
                { Logo && <ImageComponent Url={Logo.Url} Alt={Logo.Alt} className="service-card__logo service-card__logo-primary"/> }
                { Logo2 && <ImageComponent Url={Logo2.Url} Alt={Logo2.Alt} className="service-card__logo service-card__logo-secondary"/> }
              </div>
            ) : null
          }
