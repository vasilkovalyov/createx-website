...
export default function BlockIntroCarousel({ BlockType, Items, Title, Link, Text }: IBlockIntroCarousel) {
  return (
			...
			<div className="block-intro-carousel__inner">
				<Container className="block-intro-carousel__container">
					<div className="block-intro-carousel__content">
							<Typography level="h1" text={Title} className="block-intro-carousel__title text-color-light"  />
