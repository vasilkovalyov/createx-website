                                    ...
                                    PriceCol && PriceCol.length ? (
                                        PriceCol.map((item) => (
                                            <th key={item.id} className="table__head-col">
                                                {item.PricePlan && <Typography text={item.PricePlan} level="h5" className="table__head-heading text-uppercase" /> }
                                ...
                                PriceRow && PriceRow.length ? (
                                    PriceRow.map((item) => (
                                        <tr key={item.id} className="table__body-row">
                                            <td className="table__body-col">
                                                {item.Title}
                                            </td>
                                            <td className="table__body-col">
                                                {getValueOfTable(item.Available1, item.Text1)}
                                            </td>
                                            <td className="table__body-col">
                                                {getValueOfTable(item.Available2, item.Text2)}
                                            </td>
                                            <td className="table__body-col">
                                                {getValueOfTable(item.Available3, item.Text3)}
                                            </td>
                                        </tr>
                                    ))
                                ) : null
