...
export default function ContactInformation({ Theme = 'dark', className, Address, Email, Phone, Schedule }: IContactInformation) {
	const themeColor = cn({
			...
			<ul className="contact-information__list list-reset">
				...
				{ Phone && (
					<li className="contact-information__item">
						...
						<a href={`tel:${Phone}`} className="contact-information__description">{Phone}</a>
					</li>
				)}
				{ Email && (
					<li className="contact-information__item">
						<span className="contact-information__title">Email: </span>
						<a href={`mailto:${Email}`} className="contact-information__description">{Email}</a>
					</li>
				)}
				{ Schedule && (
					<li className="contact-information__item">
